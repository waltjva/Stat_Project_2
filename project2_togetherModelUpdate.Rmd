...
```{r}
# Partial F test for removing density

morereduced<-lm(quality ~ alcohol + volatile.acidity + sulphates + 
    residual.sugar + Kind + free.sulfur.dioxide + density + total.sulfur.dioxide + fixed.acidity + pH, data = train)

morereduced2<-lm(quality ~ alcohol + volatile.acidity + sulphates + 
    residual.sugar + Kind + free.sulfur.dioxide + total.sulfur.dioxide + fixed.acidity + pH, data = train)
...
```{r}
# Partial F test for removing fixed acidity and pH

morereduced2<-lm(quality ~ alcohol + volatile.acidity + sulphates + 
    residual.sugar + Kind + free.sulfur.dioxide + total.sulfur.dioxide + fixed.acidity + pH, data = train)

morereduced3<-lm(quality ~ alcohol + volatile.acidity + sulphates + 
    residual.sugar + Kind + free.sulfur.dioxide + total.sulfur.dioxide, data = train)

summary(morereduced3)

anova(morereduced3, morereduced2)
...
predsred<-predict(morereduced3,newdata=testred)
...
predswhite<-predict(morereduced3,newdata=testwhite)
...
preds<-predict(morereduced3,newdata=test)
