...
grid.arrange(bp1, bp2, bp3, bp4, bp5, bp6, bp7, bp8, bp9, bp10, bp11, ncol = 2, nrow = 12)
```
...
Forward selection model based on AIC (also the model with the best adjusted R^2):

quality = 4.089579 + 0.299231*alcohol - 0.962398*volatile.acidity + 0.881832*sulphates - 0.003293*total.sulfur.dioxide - 
          1.585888*chlorides - 0.436359*pH + 0.005371*free.sulfur.dioxide
